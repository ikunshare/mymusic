...
import static utils.DownloadUtils.inputStreamToBytes;
import static utils.HttpRequestUtils.httpGet;
...
public class ImageDownloadUtils {
  ...
  public static boolean downloadKuwoCover(String musicId, String outputPath) {
    String apiResponse = httpGet("http://artistpicserver.kuwo.cn/pic.web?corp=kuwo&type=rid_pic&pictype=500&size=500&rid=" + musicId);
